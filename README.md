...
```Dockerfile
RUN wget https://github.com/nholuongut/dumb-init/releases/download/v1.2.5/dumb-init_1.2.5_amd64.deb
...
```Dockerfile
RUN wget -O /usr/local/bin/dumb-init https://github.com/nholuongut/dumb-init/releases/download/v1.2.5/dumb-init_1.2.5_x86_64
